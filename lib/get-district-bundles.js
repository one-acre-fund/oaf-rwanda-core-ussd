...
function translate_bundle_names(bundle_name, lang) {
    try {
        var bundleNameTranslationsTable = project.getOrCreateDataTable('Bundle_Name_Translations');
...
function addProcessedBundlesToDistrict(processedBundles, districtId) {
    var table = project.getOrCreateDataTable(service.vars.input21ATable);
